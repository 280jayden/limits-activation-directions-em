"""Code cells from an earlier saved version (2026-06-24T20:08) of response_bank_llama_rank32_final.ipynb
...
BATCH_SIZE = 10
MAX_BATCHES = 100    # max generation batches per prompt
MAX_NEW_TOKENS = 600
TEMPERATURE = 1.0
...
def load_judge_prompts():
    print("Loading judge prompts from:", JUDGE_YAML_URL)
